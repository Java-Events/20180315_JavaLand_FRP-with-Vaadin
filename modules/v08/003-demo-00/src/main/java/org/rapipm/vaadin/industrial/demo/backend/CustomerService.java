package org.rapipm.vaadin.industrial.demo.backend;
...
public class CustomerService implements HasLogger {
  ...
  public synchronized void save(Customer entry) {
    requireNonNull(entry, "Customer is null. Are you sure you have connected your form to the application as described in tutorial chapter 7?");
